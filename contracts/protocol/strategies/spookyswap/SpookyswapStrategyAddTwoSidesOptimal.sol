...
contract SpookyswapStrategyAddTwoSidesOptimal is OwnableUpgradeSafe, ReentrancyGuardUpgradeSafe, IStrategy {
  ...
  modifier onlyWhitelistedWorkers() {
    require(okWorkers[msg.sender], "SpookyswapStrategyAddTwoSidesOptimal::onlyWhitelistedWorkers:: bad worker");
    _;
  }
  ...
  function _optimalDepositA(
    ...
    uint256 a = 9980;
    uint256 b = uint256(19980).mul(resA);
  ...
  function execute(
    ...
    require(
      ...
      "SpookyswapStrategyAddTwoSidesOptimal::execute:: insufficient LP tokens received"
    );
    require(
      lpToken.transfer(msg.sender, lpToken.balanceOf(address(this))),
      "SpookyswapStrategyAddTwoSidesOptimal::execute:: failed to transfer LP token to msg.sender"
    );
