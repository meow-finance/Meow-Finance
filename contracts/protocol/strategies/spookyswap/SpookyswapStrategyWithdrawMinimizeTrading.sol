...
contract SpookyswapStrategyWithdrawMinimizeTrading is OwnableUpgradeSafe, ReentrancyGuardUpgradeSafe, IStrategy {
  ...
  modifier onlyWhitelistedWorkers() {
    require(okWorkers[msg.sender], "SpookyswapStrategyWithdrawMinimizeTrading::onlyWhitelistedWorkers:: bad worker");
    _;
  }
  ...
  function execute(
    ...
    require(
      ...
      "SpookyswapStrategyWithdrawMinimizeTrading::execute:: failed to approve LP token"
    );
    ...
    require(
      ...
      "SpookyswapStrategyWithdrawMinimizeTrading::execute:: insufficient farming tokens received"
    );
    ...
    require(
      ...
      "SpookyswapStrategyWithdrawMinimizeTrading::execute:: unable to reset lp token approval"
    );
